                            ...
                            <tbody>
                                {orders.map((order) => (
                                    <tr key={order._id} className="hover:bg-gray-50">
                                        ...
                                        <td className="py-3 px-4 border-b border-gray-300 text-sm">
                                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${order.status === 'delivered' ? 'bg-primary/10 text-primary' :
                                                    order.status === 'processing' ? 'bg-orange-100 text-orange-800' :
                                                        order.status === 'shipped' ? 'bg-primary/5 text-primary-dark' :
                                        ...
                                        <td className="py-3 px-4 border-b border-gray-300 text-sm">
                                            <button
                                                ...
                                                className="bg-primary text-white px-3 py-2 rounded-md text-xs hover:bg-primary-dark transition duration-300"
                                            >
                                                View Details
                                            </button>
                                        </td>
